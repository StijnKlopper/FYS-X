...
public class Cone : MonoBehaviour
{
	...
	public void Start()
	{
		Generate(radiusTop, radiusBottom, false);
		
	}

	public void Generate(float radiusTop, float radiusBottom, bool trunkEnd)
	{
		this.radiusTop = radiusTop;
		this.radiusBottom = radiusBottom;

		//Add tree ring to the end of the branch if it is the last one.
		if (trunkEnd) 
		{
		...
		string meshName = "Bro" + numVertices + "v" + radiusTop + "t" + radiusBottom + "b" + length + "l" + length + (outside ? "o" : "") + (inside ? "i" : "");
